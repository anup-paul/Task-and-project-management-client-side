        ...
        <div>
            <div className="d-flex justify-content-center my-3" >
                <form className="w-50  border border-primary border-4 p-5 needs-validation" novalidate>
                    ...
                    <div className="">
                        <label for="validationCustom03" className="form-label">Phone <b style={{color:"red"}} >*</b></label>
                        <input type="number" className="form-control" id="validationCustom03" placeholder="Enter Client's Phone Number" required />
                        <div className="valid-feedback">
                            Looks good!
                        </div>
                    </div>
